...
LastEditTime: 2026-01-04 21:53:25
...
import pandas as pd
import time
from regressor import RPCA_tucker, RTOT_tucker, TOT_tucker, ROTR_fist_y,ttt
    ...
    for percentile in percentile_list:
        ...
        for r in range(replications):
            ...
            params = dict(
                ...
                tucker_ranks = [4,4,4,4], # 生成数据时的tucker秩
                init_scale_gen_core = 0.011,

                ranks = [4,4,4,4], # 预设的tucker秩
                lambda_x =1 ,
                lambda_y =  0.014,
                lambda_b =   0.057,
                fista_iter = 10 ,
